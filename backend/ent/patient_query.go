...
func (pq *PatientQuery) QueryTitle() *TitleQuery {
...
func (pq *PatientQuery) QueryJob() *JobQuery {
...
func (pq *PatientQuery) WithTitle(opts ...func(*TitleQuery)) *PatientQuery {
	query := &TitleQuery{config: pq.config}
	for _, opt := range opts {
		opt(query)
	}
...
func (pq *PatientQuery) WithJob(opts ...func(*JobQuery)) *PatientQuery {
	query := &JobQuery{config: pq.config}
	for _, opt := range opts {
		opt(query)
	}
...
func (pq *PatientQuery) sqlAll(ctx context.Context) ([]*Patient, error) {
	...
	if pq.withGender != nil || pq.withTitle != nil || pq.withJob != nil {
		withFKs = true
	}
	if withFKs {
