...
func (e TitleEdges) PatientsOrErr() ([]*Patient, error) {
	if e.loadedTypes[0] {
...
// QueryPatients queries the patients edge of the Title.
func (t *Title) QueryPatients() *PatientQuery {
	return (&TitleClient{config: t.config}).QueryPatients(t)
}
